...
module.exports = React.createClass({
    ...
    validateField: function(field_id) {
        ...
        switch (field_id) {
            case FIELD_EMAIL:
                ...
                if (email === '') {
                    this.markFieldValid(field_id, false, "RegistrationForm.ERR_EMAIL_BLANK");
                } else if (!Email.looksValid(email)) {
                    this.markFieldValid(field_id, false, "RegistrationForm.ERR_EMAIL_INVALID");
                } else {
    ...
    render: function() {
        const self = this;
        const emailPlaceholder = _t("Email address");
